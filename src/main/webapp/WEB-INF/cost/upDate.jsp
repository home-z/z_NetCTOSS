    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="" method="" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" name="baseDuration" value="${val.baseDuration }" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" name="baseCost" value="${val.baseCost }" class="width100" />
                ...
                <div class="input_info">
                    <input type="text" name="unitCost" value="${val.unitCost }" class="width100" />
                ...
                <div class="input_info_high">
                    <textarea class="width300 height70" name="descr">${val.descr }</textarea>
